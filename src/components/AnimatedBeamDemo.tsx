...
export default function AnimatedBeamDemo() {
    ...
    return (
        <div
            ref={containerRef}
            className="relative h-96 flex md:w-2/3 w-full justify-center lg:gap-20 gap-8"
        >
            ...
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 md:-translate-y-1/4 -translate-y-1/2 bottom-0 z-20 h-full w-full rounded-full shadow-xl">
